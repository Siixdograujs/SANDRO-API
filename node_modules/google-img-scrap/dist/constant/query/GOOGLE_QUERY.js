...
for (const EXTENSION of EXTENSIONS_1.EXTENSIONS) {
    ...
    GOOGLE_QUERY.EXTENSION[queryName] = GOOGLE_PARAMS_1.default.IMAGE_EXTENSION + ':' + EXTENSION;
}
//build colors
for (const COLOR of GOOGLE_COLORS_1.default) {
    const queryName = COLOR.toUpperCase();
    GOOGLE_QUERY.COLOR[queryName] =
        GOOGLE_PARAMS_1.default.COLOR + ':specific,' + GOOGLE_PARAMS_1.default.SPECIFIC_COLOR + ':' + COLOR;
}
